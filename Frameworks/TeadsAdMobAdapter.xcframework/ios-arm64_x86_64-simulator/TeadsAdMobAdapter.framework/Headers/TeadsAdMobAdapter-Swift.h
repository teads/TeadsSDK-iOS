...
#ifndef TEADSADMOBADAPTER_SWIFT_H
#define TEADSADMOBADAPTER_SWIFT_H
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull defaultLabel SWIFT_DEPRECATED_MSG("defaultLabel is not used anymore please pass your label value as parameter of the customEventExtra method");)
...
/// important:
///
/// This method is deprecated if favor of registering directly <code>TeadsSDK.TeadsAdapterSettings</code>
/// \code
...
///
/// \endcode\param teadsAdSettings the TeadsAdapterSettings that you will pass as extra parameters for the mediation.
///
/// \param label the same label as it registered on your Google dashboard, default value is Teads.
///
+ (GADCustomEventExtras * _Nonnull)customEventExtraWith:(TeadsAdapterSettings * _Nonnull)teadsAdSettings for:(NSString * _Nonnull)label SWIFT_WARN_UNUSED_RESULT SWIFT_UNAVAILABLE_MSG("customEventExtra is not available anymore, you can register TeadsAdapterSettings directly calling `GADRequest.register(_ )");
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol GADAdNetworkExtras;
@class GADMediationServerConfiguration;
SWIFT_CLASS_NAMED("GADMAdapterTeadsCustomEvent")
@interface GADMAdapterTeadsCustomEvent : NSObject <GADMediationAdapter>
...
+ (void)setUpWithConfiguration:(GADMediationServerConfiguration * _Nonnull)_ completionHandler:(GADMediationAdapterSetUpCompletionBlock _Nonnull)completionHandler;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class GADMediationBannerAdConfiguration;
SWIFT_CLASS_NAMED("GADMAdapterTeadsBanner")
@interface GADMAdapterTeadsBanner : GADMAdapterTeadsCustomEvent
...
@class UIView;
SWIFT_CLASS_NAMED("GADMAdapterTeadsBannerAd")
@interface GADMAdapterTeadsBannerAd : NSObject <GADMediationBannerAd>
@property (nonatomic, readonly, strong) UIView * _Nonnull view;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol TeadsAdPlacementIdentifiable;
@interface GADMAdapterTeadsBannerAd (SWIFT_EXTENSION(TeadsAdMobAdapter)) <TeadsAdPlacementEventsDelegate>
- (void)adPlacement:(id <TeadsAdPlacementIdentifiable> _Nullable)_ didEmitEvent:(enum TeadsAdPlacementEventName)event data:(NSDictionary<NSString *, id> * _Nullable)data;
@end
...
@interface GADMAdapterTeadsBannerAd (SWIFT_EXTENSION(TeadsAdMobAdapter)) <TeadsInReadAdPlacementDelegate>
...
- (void)adOpportunityTrackerViewWithTrackerView:(TeadsAdOpportunityTrackerView * _Nonnull)_;
- (void)didUpdateRatioWithAd:(TeadsInReadAd * _Nonnull)_ adRatio:(TeadsAdRatio * _Nonnull)adRatio;
@end

@class TeadsAd;
@class UIViewController;
@interface GADMAdapterTeadsBannerAd (SWIFT_EXTENSION(TeadsAdMobAdapter)) <TeadsAdDelegate>
...
- (void)didExpandedToFullscreenWithAd:(TeadsAd * _Nonnull)_;
- (void)didCollapsedFromFullscreenWithAd:(TeadsAd * _Nonnull)_;
@end

@class GADMediationInterstitialAdConfiguration;
SWIFT_CLASS_NAMED("GADMAdapterTeadsInterstitial")
@interface GADMAdapterTeadsInterstitial : GADMAdapterTeadsCustomEvent
...
SWIFT_CLASS_NAMED("GADMAdapterTeadsInterstitialAd")
@interface GADMAdapterTeadsInterstitialAd : NSObject <GADMediationInterstitialAd>
- (void)presentFromViewController:(UIViewController * _Nonnull)viewController;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface GADMAdapterTeadsInterstitialAd (SWIFT_EXTENSION(TeadsAdMobAdapter)) <TeadsAdPlacementEventsDelegate>
- (void)adPlacement:(id <TeadsAdPlacementIdentifiable> _Nullable)_ didEmitEvent:(enum TeadsAdPlacementEventName)event data:(NSDictionary<NSString *, id> * _Nullable)data;
@end

@interface GADMAdapterTeadsInterstitialAd (SWIFT_EXTENSION(TeadsAdMobAdapter)) <TeadsFullScreenEventsDelegate>
- (void)fullScreenPlacement:(id <TeadsAdPlacementIdentifiable> _Nullable)placement didEmitEvent:(enum TeadsFullScreenEventName)event data:(NSDictionary<NSString *, id> * _Nullable)data;
@end

@class GADMediationNativeAdConfiguration;
SWIFT_CLASS_NAMED("GADMAdapterTeadsNative")
@interface GADMAdapterTeadsNative : GADMAdapterTeadsCustomEvent
