...
#ifndef TEADSAPPLOVINADAPTER_SWIFT_H
#define TEADSAPPLOVINADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TeadsAppLovinAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface MAAdView (SWIFT_EXTENSION(TeadsAppLovinAdapter))
- (void)registerWithTeadsAdSettings:(TeadsAdapterSettings * _Nonnull)teadsAdSettings;
@end

@interface MANativeAdLoader (SWIFT_EXTENSION(TeadsAppLovinAdapter))
- (void)registerWithTeadsAdSettings:(TeadsAdapterSettings * _Nonnull)teadsAdSettings;
@end
