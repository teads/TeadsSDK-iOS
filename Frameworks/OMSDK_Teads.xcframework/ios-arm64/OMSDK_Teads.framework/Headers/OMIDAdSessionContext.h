 ...
 */
@interface OMIDTeadsAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDTeadsPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDTeadsPartner *)partner
                               ...
                               resources:(NSArray<OMIDTeadsVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
...
- (nullable instancetype)initWithPartner:(OMIDTeadsPartner *)partner
                              ...
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                           universalAdID:(nullable OMIDTeadsUniversalAdID *)universalAdID
                                   error:(NSError *_Nullable *_Nullable)error;
