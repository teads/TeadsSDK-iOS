 ...
 */
@interface OMIDTeadsAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDTeadsAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDTeadsVASTProperties *_Nonnull)vastProperties
