 ...
 */
@interface OMIDTeadsAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDTeadsAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDTeadsAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDTeadsAdSessionContext *)context
