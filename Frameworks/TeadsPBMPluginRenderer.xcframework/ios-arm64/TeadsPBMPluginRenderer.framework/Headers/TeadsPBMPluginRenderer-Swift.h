...
#ifndef TEADSPBMPLUGINRENDERER_SWIFT_H
#define TEADSPBMPLUGINRENDERER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TeadsPBMPluginRenderer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22TeadsPBMPluginRenderer22TeadsPBMPluginRenderer")
@interface TeadsPBMPluginRenderer : NSObject
/// Initialize with optional custom settings
/// \param settings Teads adapter settings (integration type/version auto-set)
///
- (nullable instancetype)initWithSettings:(TeadsAdapterSettings * _Nonnull)settings OBJC_DESIGNATED_INITIALIZER;
...
@interface TeadsPBMPluginRenderer (SWIFT_EXTENSION(TeadsPBMPluginRenderer)) <TeadsInReadAdPlacementDelegate>
...
@interface TeadsPBMPluginRenderer (SWIFT_EXTENSION(TeadsPBMPluginRenderer)) <TeadsAdDelegate>
...
@interface TeadsPBMPluginRenderer (SWIFT_EXTENSION(TeadsPBMPluginRenderer)) <PrebidMobilePluginRenderer>
