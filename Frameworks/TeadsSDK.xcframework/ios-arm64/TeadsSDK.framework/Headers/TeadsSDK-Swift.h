...
/// In order to dynamically identifies a dependency class, a class must be declared conforming to this protocol
/// This will help Teads to identify which dependency manager is used by the app owner:
/// <ul>
///   <li>
///     CocoaPods
///   </li>
...
///   </li>
/// </ul>
SWIFT_PROTOCOL("_TtP8TeadsSDK18DependencyProtocol_")
