...
/// This value is optional since AdFailReason objects can be returned without an ad requests attached
...
/// <code>Teads Crash Monitoring</code> is a tool we use to monitor crashes that may occur IN OUR SDK ONLY.
