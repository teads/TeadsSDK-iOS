...
(function() {
    ...
    window.adPlayerOutput.notifyProgressUpdated = function notifyProgressUpdated(currentTime, durationTime) {
        const message = JSON.stringify({"currentTime": currentTime, "durationTime": durationTime})
        window.webkit.messageHandlers.notifyProgressUpdated.postMessage(message);
    };
