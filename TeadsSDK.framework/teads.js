;(function() {
  ...
  var jsonVariables = {"userId":userId};
  ...
  var jsonVariables = {"callId":callId, "url":url, "method":method,
  "headersString": headersString, "formString":formString, "timeOut":timeout};
  var jsonString = JSON.stringify(jsonVariables);
  ...
  var jsonVariables = {"mimeType": mimeType,
  "ratio": ratio, "response": response, "adParameters": adParameters};
  var jsonString = JSON.stringify(jsonVariables);
  window.webkit.messageHandlers.ad.postMessage(jsonString)
  }
  
  window.teads.configureViews = function configureViews(json) {
  var jsonVariables = {"json":json};
  var jsonString = JSON.stringify(jsonVariables);
  ...
  var jsonVariables = {"duration":duration};
  var jsonString = JSON.stringify(jsonVariables);
  ...
  var jsonVariables = {"volume":volume, "transitionDuration":transitionDuration};
  var jsonString = JSON.stringify(jsonVariables);
