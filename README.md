...
- Installation guide is available [here](https://developers.teads.com/docs/iOS-SDK/Installation/).
- Full integration guide is available [here](https://developers.teads.com/docs/iOS-SDK/Integration-Guide/).

## 🕊 Migrating to v6

TeadsSDK v6 introduces a new unified `createPlacement` API. See [Migration Documentation](https://developers.teads.com/docs/iOS-SDK/Teads-SDK-Migration/) for details.
...
See [changelog here](https://github.com/teads/TeadsSDK-iOS/releases) or check the [Release Notes](https://developers.teads.com/docs/iOS-SDK/Release-Notes/).
