...
class InReadDirectScrollViewController: TeadsViewController {
    ...
    override func viewDidLoad() {
        ...
        // Load ad
        placement?.loadAd(adResponse: PrebidAdResponse.TAMEDIA_FAKE_WINNING_BID_RESPONSE, requestSettings: adRequestSettings)
    }
